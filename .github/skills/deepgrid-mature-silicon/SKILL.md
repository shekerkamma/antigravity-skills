...
- **For Deep SKU Technical Sheets** — Use the companion skill `/deepgrid-sku-compendium` or open the [Native Vector Console](http://localhost:3456/deepgrid_native_viewer.html).
