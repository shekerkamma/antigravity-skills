...
**Strict Vector Asset Protocol (Zero Hallucination / Zero Ugly Re-Draws):**
- **NEVER** use AI image generation (`generate_image`) to fabricate fictional schematics or architecture sheets.
...
- For interactive dashboards, render native vector pages using client-side **PDF.js** to avoid clunky browser PDF chrome and nested scrollbars.
